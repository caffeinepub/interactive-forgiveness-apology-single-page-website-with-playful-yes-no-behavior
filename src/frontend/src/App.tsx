...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <main className="w-full max-w-2xl z-10">
        {!forgiven ? (
          ...
          <div className="relative">
            <HeartsBurst />
            <div className="bg-card border-2 border-primary/20 rounded-3xl shadow-2xl p-8 md:p-12 text-center space-y-6 float-animation">
              ...
              <div className="space-y-4 text-lg md:text-xl text-foreground/90 leading-relaxed">
                ...
                <p>
                  From today, I will change the way I speak. 🙏
                </p>
                <p>
                  sorry mujhe maaf kardo, mere bolne se aapko shak lagta hai but mai nahi karta hun shak aapse , sorry kiki aaj se try karunga sahi se baat karna I'm really sorry aapko asa feel karane keliye
                </p>
      ...
      {/* Footer */}
      <footer className="fixed bottom-4 left-0 right-0 text-center text-sm text-muted-foreground z-10">
        <p>
